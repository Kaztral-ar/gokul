(()=>{
  ...
  function sound(){
    ...
    o.connect(g); g.connect(audio.destination); o.start(n); o.stop(n + .1);
  }
  ...
  if(cryptoTicker){
    const holdings=document.createElement('section');holdings.className='crypto-holdings';holdings.setAttribute('aria-label','Crypto holdings');
    holdings.innerHTML=`<h2 class="section-title">Crypto</h2><div class="crypto-holdings-bar" role="img" aria-label="PEPE 60 percent, USDT 25 percent, PI 15 percent"><span class="holding-segment pepe" style="--share:60%" title="PEPE · 60%"></span><span class="holding-segment usdt" style="--share:25%" title="USDT · 25%"></span><span class="holding-segment pi" style="--share:15%" title="PI · 15%"></span></div><div class="crypto-holdings-labels"><span class="pepe-label">🐸 PEPE · 60%<small>≈ 5,528,118 PEPE</small></span><span class="usdt-label">₮ USDT · 25%<small>≈ 7.82 USDT</small></span><span class="pi-label">π PI · 15%<small>≈ 51.31 PI</small></span></div>`;
    const style=document.createElement('style');style.textContent=`.crypto-holdings{margin:30px 0 0;padding:0;font-family:'IBM Plex Mono',monospace;color:#111}.crypto-holdings .section-title{margin:0 0 16px;margin-left:40px}.crypto-holdings-bar{display:flex;width:min(68%,720px);height:10px;margin:0;overflow:hidden;border:1px solid rgba(0,0,0,.12);border-radius:999px;background:#f5f5f5}.holding-segment{display:block;width:var(--share);height:100%;min-width:2px;border-right:2px solid #fff}.holding-segment:last-child{border-right:0}.holding-segment.pepe{background:#2dbb73}.holding-segment.usdt{background:#2678e8}.holding-segment.pi{background:#7b45d6}.crypto-holdings-labels{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin-top:9px;font-size:9px;text-align:center}.crypto-holdings-labels span{display:flex;flex-direction:column;align-items:center;gap:4px;min-width:0;white-space:nowrap}.crypto-holdings-labels small{font:500 9px/1.2 'IBM Plex Mono',monospace;color:#666;overflow:hidden;text-overflow:ellipsis}.pepe-label{color:#24965c}.usdt-label{color:#1d64c5}.pi-label{color:#6833bb}@media(max-width:700px){.crypto-holdings{margin-top:24px}.crypto-holdings .section-title{margin-bottom:16px;margin-left:40px}.crypto-holdings-bar{width:88%;margin:0;height:10px}.crypto-holdings-labels{gap:6px;font-size:7px}.crypto-holdings-labels small{font-size:7px}}`;document.head.appendChild(style);cryptoTicker.parentNode.insertBefore(holdings,cryptoTicker);
  }
