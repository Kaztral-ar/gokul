(()=>{
  ...
  style.textContent = `
    ...
    .work-tree:before{
      ...
      position:absolute;
      left:18px;
      top:var(--work-main-line-top,18px);
      height:var(--work-main-line-height,0px);
      width:1px;
      background:#d9dee7;
      pointer-events:none
    }
    ...
    .work-folder.apps{color:#c56b20}
    .work-folder.tools{color:#5b31d4}
    ...
    .work-name:before{
      ...
      border-radius:1px;
      background:linear-gradient(135deg,transparent 0 68%,#fff 68% 100%);
