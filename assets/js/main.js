(()=>{
  ...
  // One unified crypto holdings bar: PEPE 60%, USDT 25%, PI 15% of ₹3,000.
  ...
  if(cryptoTicker){
    ...
    holdings.setAttribute('aria-label','Crypto holdings: PEPE 60 percent, USDT 25 percent, PI 15 percent. Total 3000 rupees.');
    holdings.innerHTML=`
      <div class="crypto-holdings-head">
        <span>Crypto holdings</span>
        <span>₹3,000</span>
      </div>
      <div class="crypto-holdings-bar" role="img" aria-label="PEPE 60%, USDT 25%, PI 15%">
        <span class="holding-segment pepe" style="--share:60%" title="PEPE · 60% · ₹1,800"></span>
        <span class="holding-segment usdt" style="--share:25%" title="USDT · 25% · ₹750"></span>
        <span class="holding-segment pi" style="--share:15%" title="PI · 15% · ₹450"></span>
      </div>
      <div class="crypto-holdings-labels">
        <span>PEPE <b>60%</b></span><span>USDT <b>25%</b></span><span>PI <b>15%</b></span>
      </div>`;
    ...
    style.textContent=`
      ...
      .holding-segment.usdt{background:#777}.holding-segment.pi{background:#bbb}.holding-segment:last-child{border-right:0}
      ...
      .crypto-holdings-labels span{flex:0 0 auto}.crypto-holdings-labels b{font-weight:600;opacity:1}
      @media(max-width:700px){.crypto-holdings{margin-top:24px}.crypto-holdings-bar{height:10px}.crypto-holdings-labels{font-size:8px;gap:6px}.crypto-holdings-head{font-size:9px}}
    `;
